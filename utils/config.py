...
__all__ = [
    ...
    "NON_ADMIN_ROLE_IDS",
    "TRUSTED_TEMP_VOICE_BOT_IDS",
    "NON_RECOVERABLE_CHANNEL_IDS",
...
NAME = env_str("BOT_NAME", "DARK INFINITE")
...
OWNER_ADMIN_ROLE_NAME = '𖣂'
LEGACY_OWNER_ADMIN_ROLE_NAME = '>"<'
NON_ADMIN_ROLE_IDS = frozenset({1544218763975725089})
TRUSTED_TEMP_VOICE_BOT_IDS = frozenset({762217899355013120, 1483078930343923806})
NON_RECOVERABLE_CHANNEL_IDS = frozenset({1550473673968844870})
...
LAVALINK_ENABLED = env_bool("LAVALINK_ENABLED", False)
